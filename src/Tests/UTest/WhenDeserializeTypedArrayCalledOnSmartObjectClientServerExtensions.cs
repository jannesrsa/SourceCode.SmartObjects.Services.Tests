...
{
    [TestClass()]
    public class WhenDeserializeTypedArrayCalledOnSmartObjectClientServerExtensions
    {
        [TestMethod()]
        public void With_ProcessInfo()
        {
            ...
            smartObject.Load(GetType().Assembly.GetManifestResourceStream("SourceCode.SmartObjects.Services.Tests.UTest.Resources.SmartObject_ProcessInfo.xml"));
            ...
            mockSmartObjectClientServer.Setup(x => x.ExecuteListDataTable(It.IsAny<SmartObject>(), It.IsAny<ExecuteListOptions>())).Returns(expected);

            ConnectionHelper.UpdateConnectionProvider(mockConnectionProvider.Object);

            // Act
            var actual = SmartObjectClientServerExtensions.DeserializeTypedArray(mockSmartObjectClientServer.Object, serviceObjectName, settings.Object, value);
        ...
        public void WithServerNull()
        {
            ...
            // Act
            SmartObjectClientServerExtensions.DeserializeTypedArray(server, serviceObjectName, settings.Object, value);
        }
    }
}