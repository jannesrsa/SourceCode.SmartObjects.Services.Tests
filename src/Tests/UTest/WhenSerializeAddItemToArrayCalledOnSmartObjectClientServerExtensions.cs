...
{
    [TestClass()]
    public class WhenSerializeAddItemToArrayCalledOnSmartObjectClientServerExtensions
    {
        [TestMethod()]
        ...
        public void WithServerNull()
        {
            ...
            // Act
            SmartObjectClientServerExtensions.SerializeAddItemToArray(server, serviceObjectName, string.Empty, settings.Object, action);
        }
    }
}